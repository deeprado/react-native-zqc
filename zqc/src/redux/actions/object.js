...
export function cacheUsers({users, userIds}) {
  return (dispatch, getState) => {
    ...
    if (userStats.length > 0) {
      ps.push(dispatch(cacheUserStats({userStats, userStatIds})));
    } else {
...
export function cacheUserByIds({userIds, update = false}) {
  return (dispatch, getState) => {
    ...
    if (userIds.length > 0) {
      return apis.userInfos(userIds).then(response => {
        let {
          data: {users},
        } = response;
...
export function cachePostByIds({postIds, update = false}) {
  return (dispatch, getState) => {
    ...
    if (postIds.length > 0) {
      return apis.postInfos(postIds).then(response => {
        let {
          data: {posts},
        } = response;
...
export function cachePostCommentByIds({postCommentIds, update = false}) {
  return (dispatch, getState) => {
    ...
    if (postCommentIds.length > 0) {
      return apis.postCommentInfos(postCommentIds).then(response => {
        let {
...
export function cacheCourtByIds({courtIds, update = false}) {
  return (dispatch, getState) => {
    ...
    if (courtIds.length > 0) {
      return apis.courtInfos(courtIds).then(response => {
        let {
          data: {courts},
        } = response;
...
export function cacheFileByIds({fileIds, update = false}) {
  return (dispatch, getState) => {
    ...
    if (fileIds.length > 0) {
      return apis.fileInfos(fileIds).then(response => {
        let {
          data: {files},
        } = response;
...
export function cacheUserStatByIds({userStatIds, update = false}) {
  return (dispatch, getState) => {
    ...
    if (userStatIds.length > 0) {
      return apis.userStats(userStatIds).then(response => {
        let {
...
export function cachePostStatByIds({postStatIds, update = false}) {
  return (dispatch, getState) => {
    ...
    if (postStatIds.length > 0) {
      return apis.postStats(postStatIds).then(response => {
        let {
          data: {stats: postStats},
        } = response;
...
export function cacheCourtStatByIds({courtStatIds, update = false}) {
  return (dispatch, getState) => {
    ...
    if (courtStatIds.length > 0) {
      return apis.courtStats(courtStatIds).then(response => {
        let {
          data: {stats: courtStats},
        } = response;
...
export function cacheFileStatByIds({fileStatIds, update = false}) {
  return (dispatch, getState) => {
    ...
    if (fileStatIds.length > 0) {
      return apis.fileStats(fileStatIds).then(response => {
        let {
