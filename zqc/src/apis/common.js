...
import {loadingStart, loadingEnd, resetLoading} from '../redux/actions/loading';
...
export function getApi(
  url,
  params = {},
  {headers = {}, timeout = 3000, background = false, onDownloadProgress} = {},
) {
  return requestApi({
    url,
    method: 'GET',
...
export function postApi(
  url,
  data = {},
  {headers = {}, timeout = 5000, background = false, onUploadProgress} = {},
) {
...
export function requestApi(config) {
  ...
  config.baseURL = ENVS.development.api_base_url;
